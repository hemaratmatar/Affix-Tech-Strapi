...
const Routes = ({ logout, auth: {userid} }) => {
    console.log(userid);
  return (
    <Fragment>
      {/* <Layout/> */}
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-red-200">
                  ...
                  <div className="mt-3 px-2 space-y-1">
                    ...
                    <Disclosure.Button onClick={logout} className="block px-3 py-2 w-full text-left rounded-md text-base font-medium text-white hover:text-white hover:bg-red-300">
                      {/* <Link to="/" > */}
