...
const Comment = ({comment:{id, attributes}}) => {

  return (
    <div className=" ">
    <div className=" flex float-none justify-items-stretch items-center bg-red-300  p-3  rounded-t-xl">
      <div className="justify-self-start w-10"><img
        ...
        alt=""
      /></div>
      <div className=" flex-1"><p className="px-4 text-sm font-bold">{/*Comment Contents*/}{attributes.users_permissions_user.data.attributes.username}</p></div>
