...
-- DROP TABLE admin_permissions_role_links;
-- DROP TABLE admin_roles;
-- DROP TABLE admin_users;
-- DROP TABLE admin_users_roles_links;
-- DROP TABLE files;
-- DROP TABLE files_related_morphs;
-- DROP TABLE i18n_locale;
-- DROP TABLE posts;
-- DROP TABLE posts_users_permissions_user_links;
-- DROP TABLE profiles;
-- DROP TABLE reports;
-- DROP TABLE reports_post_links;
-- DROP TABLE strapi_api_tokens;
-- DROP TABLE strapi_core_store_settings;
-- DROP TABLE strapi_database_schema;
-- DROP TABLE strapi_migrations;
-- DROP TABLE strapi_webhooks;
-- DROP TABLE up_permissions;
-- DROP TABLE up_permissions_role_links;
-- DROP TABLE up_roles;
-- DROP TABLE up_users;
-- DROP TABLE up_users_role_links;
--
